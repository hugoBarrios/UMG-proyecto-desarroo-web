...
<body>
    ...
    <nav>
        <div class="nav-wrapper  teal lighten-1">
            <a href="#" class="brand-logo center">Asignacion</a>
    ...
    <div class="row">
        ...
        <form class="col s4 card" method="POST">
            ...
            <div class="row">
                <div class="input-field col s12">
                    <input id="last_name" type="text" class="validate" name="materia">
                    <label for="last_name">Materia</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                    <input id="last_name" type="text" class="validate" name="curso">
                    <label for="last_name">Curso</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                    <input id="last_name" type="text" class="validate" name="inicio">
                    <label for="last_name">Hora de Inicio</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                    <input id="last_name" type="text" class="validate" name="fin">
                    <label for="last_name">Hora de Fin</label>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col s8">
            ...
            <?php
                ...
                $busrcar = "SELECT * FROM asignacion";
