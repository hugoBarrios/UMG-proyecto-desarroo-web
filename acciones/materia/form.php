...
<body>
    ...
    <nav>
        <div class="nav-wrapper  teal lighten-1">
            <a href="#" class="brand-logo center">Materia</a>
        ...
        <form class="col s4 card" method="POST">
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <label for="last_name">ID Materia</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                    <input id="last_name" type="text" class="validate" name="catedratico">
                    <label for="last_name">ID Catedratico</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
    ...
    <div class="row">
        ...
        <div class="col s8">
            ...
            ?>
                        ...
                        <td><?php echo $filas['ID_catedratico']?></td>
